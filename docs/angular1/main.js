...
var AddBookComponent = /** @class */ (function () {
    function AddBookComponent() {
        ...
        this.bookCreatedEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.newBook = '';
        this.status = 1;
    }
    AddBookComponent.prototype.ngOnInit = function () { };
    // .emit() wysyla dane do nadrzednego elementu
    AddBookComponent.prototype.onAddNewBook = function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])('addBook'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], AddBookComponent.prototype, "bookCreatedEvent", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('newBook'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], AddBookComponent.prototype, "inputValue", void 0);
...
module.exports = "<app-header></app-header>\n<div class=\"container\">\n  <h1 class=\"text-center my-3 my-md-4\">{{ mainTitle }}</h1>\n  <app-add-book\n    (addBook)=\"onNewBookAdded($event)\">    \n  </app-add-book>\n\n  <div class=\"row\">\n    <div class=\"col-md-12\">\n      <h2>{{ sectionTitle1 }}</h2>\n      <ul class=\"list-group my-3 my-md-4\">\n        <app-book \n          *ngFor=\"let bookOnShelf of booksOnshelf\"\n          [book]=\"bookOnShelf\">\n      </app-book>\n      </ul>\n    </div>\n  </div>\n</div>"
...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.mainTitle = 'My Books';
        this.sectionTitle1 = 'My Bookshelf';
        this.booksOnshelf = [
            { title: 'The Slight Edge', status: 1 },
            { title: 'Robotocalypse', status: 1 }
        ];
    }
    AppComponent.prototype.onNewBookAdded = function (bookData) {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _add_book_add_book_component__WEBPACK_IMPORTED_MODULE_7__["AddBookComponent"]
            ],
            imports: [
...
var BookComponent = /** @class */ (function () {
    ...
    BookComponent.prototype.changeStatus = function () {
        this.book.status += 1;
...
module.exports = __webpack_require__(/*! D:\Projekty WWW\Cwiczeniowe\Angular\angular1\src\main.ts */"./src/main.ts");
